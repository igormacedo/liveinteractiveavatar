...
Filename    :   Win32_GLAppUtil.h
Content     :   OpenGL and Application/Window setup functionality for RoomTiny
Changes		:	Suport for Kinect v2 - with avatar rederization
				Physics simulation with BulletEngine
...
//Libraries to deal with the Kinect and BulletEngine
#include "../../OculusRoomTiny/OculusRoomTiny (GL)/Projects/Windows/VS2013/KinectHandler.h"
#include "btBulletDynamicsCommon.h"
#include <iostream>

//Definition for Kinect frames resolution
